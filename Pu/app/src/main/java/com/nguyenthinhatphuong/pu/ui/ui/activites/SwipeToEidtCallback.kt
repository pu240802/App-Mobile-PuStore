...
abstract class SwipeToEidtCallback(context: Context)
    ...
    private val clearnPaint = Paint().apply { xfermode = PorterDuffXfermode(PorterDuff.Mode.CLEAR) }
    ...
    private  fun clearCanvas(c: Canvas?, left: Float, top: Float, right: Float, bottom: Float){
        c?.drawRect(left, top, right, bottom, clearnPaint)
    }
